  ...
  return (
    <div className="work_page page-shell">
      ...
      <div className="work_hero">
        ...
        <h2 data-aos="fade-down" data-aos-delay="100">Built</h2>
      </div>

      <div className="container portfolio__container work_container">
        <MaybeTilt>
            ...
            <div className="portfolio__item-image mdp">
              <div className="mdp__inner">
                ...
                <svg className="mdp__gauge" viewBox="0 0 100 53">
                  <defs>
                    <linearGradient id="mdp-g2" x1="6" y1="0" x2="94" y2="0" gradientUnits="userSpaceOnUse">
                  ...
                  <path d="M 6 50 A 44 44 0 0 1 87.1 26.4"  fill="none" stroke="url(#mdp-g2)" strokeWidth="3"  strokeLinecap="round" />
                  <path d="M 16 50 A 34 34 0 0 1 74.0 26.0" fill="none" stroke="url(#mdp-g2)" strokeWidth="9"  strokeLinecap="round" />
                  <path d="M 26 50 A 24 24 0 0 1 64.1 30.6" fill="none" stroke="url(#mdp-g2)" strokeWidth="14" strokeLinecap="round" />
        ...
        <MaybeTilt>
          <article data-aos="zoom-in-up" data-aos-delay="400" className="portfolio__items">
            <div className="portfolio__item-image rbp-preview">
              <div className="rbp-inner">
                ...
                <svg className="rbp-chart" viewBox="0 0 120 46">
                  ...
                  <circle className="rbp-chart-end" cx="116" cy="6" r="2.5" fill="#16a34a" />
                </svg>
            ...
            <h3>Rapid Bulk Plan <span className="work-tag">#tool</span></h3>
            <small>
